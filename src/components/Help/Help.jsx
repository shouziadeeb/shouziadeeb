    ...
    <div style={styles.container}>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.faq}>
          ...
          <p>
            To track your order, go to the "My Orders" section in your account.
            You will see real-time updates on the status of your order, from
            when it’s being prepared to when it’s out for delivery.
          </p>
        </div>
        ...
        <div style={styles.faq}>
          ...
          <p>
            ...
            estimated delivery time for potential delays during peak hours. You
            can check the status in the "My Orders" section or contact our
            support team if the delay exceeds 30 minutes.
          </p>
        </div>

        <div style={styles.faq}>
          <h3>3. My order was incorrect or missing items, what should I do?</h3>
          <p>
            In case of incorrect or missing items, go to the "My Orders"
            section, click on the order, and select the "Report an Issue"
            option. Follow the prompts to get a resolution, such as a refund or
            redelivery.
          </p>
        </div>
      </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.faq}>
          ...
          <p>
            You can update your payment method by going to the "Payment Methods"
            section in your account settings. You can add new credit/debit
            cards, link a PayPal account, or choose to pay via digital wallets
        ...
        <div style={styles.faq}>
          ...
          <p>
            Refunds are typically processed within 5-7 business days, depending
            on your payment provider. You will receive an email notification
        ...
        <div style={styles.faq}>
          ...
          <p>
            Payments can be declined for several reasons, including insufficient
            funds, incorrect card details, or issues with the payment provider.
            Please double-check your information and try again, or contact your
      ...
      <div style={styles.section}>
        ...
        <div style={styles.faq}>
          ...
          <p>
            You can update your name, email address, phone number, and delivery
            address in the "Account Settings" section of the app. Remember to
      ...
      <div style={styles.section}>
        ...
        <div style={styles.faq}>
          ...
          <p>
            ...
            restaurant to your delivery address, and any ongoing promotions. The
            fee will be clearly shown at checkout.
          </p>
        </div>
      ...
      <div style={styles.section}>
        ...
        <div style={styles.faq}>
          ...
          <p>
            Promo codes can be applied at checkout. Enter the code in the "Promo
            Code" field, and the discount will be automatically applied to your
            order if the code is valid.
          </p>
        </div>
      ...
      <div style={styles.section}>
        ...
        <p>
          ...
          <a href="/feedback">Feedback Page</a> to share your thoughts or report
          any issues.
        </p>
      </div>
    </div>
